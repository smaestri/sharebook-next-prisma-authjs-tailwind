  ...
  return (
    <>
      ...
      <div>
        ...
        <p>Et n'oubliez pas d'ajouter cette personne en tant qu'ami, en cliquant sur son nom dans la page du livre. Ainsi, cela vous permettra de facilement voir ses livres via le lien "Mes amis" du menu utilisateur! De plus, cette page vous permet d'inviter une personne qui ne serait pas encore inscrite: quand celle-ci se connectera au site, elle deviendra automatiquement votre ami!</p>
        <p>Bonne visite!</p>
        </div>
